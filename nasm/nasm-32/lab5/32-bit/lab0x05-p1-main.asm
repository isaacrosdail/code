...
section .data
    ...
    error_length db "Please enter at least one letter!", 0x0A
    error_length_size equ $ - error_length
    goodbye db "Empty line entered, ending program.", 0x0A
    goodbye_size equ $ - goodbye
...
exit_textPtr_loop:
    mov eax, SYS_WRITE      ;; Print goodbye message
    mov ebx, STDOUT
    mov ecx, goodbye
    mov edx, goodbye_size
    int 0x80
